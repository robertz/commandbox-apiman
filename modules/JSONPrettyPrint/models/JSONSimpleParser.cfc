component {
    ...
    private any function parseObject(src, pos) {
        ...
        var parsed = {type: 'object', elements: []};
    ...
    private any function parseArray(src, pos) {
        ...
        var parsed = {type: 'array', elements: []};
    ...
    private any function parseElement(src, pos) {
        ...
        if (matcher.lookingAt()) {
            return {type: 'element', start: matcher.start('token'), end: matcher.end('token')};
        }
    }
    ...
    private any function parseKeyValue(src, pos) {
        ...
        parsed.key = {type: 'element', start: matcher.start('token'), end: matcher.end('token')};
